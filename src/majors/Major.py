...
def art_history(transcript,type):
...
def art_education(transcript, type):
...
def graphic_design(transcript, type):
...
def studio_art(transcript,type):
...
def biology_bs(transcript,type):
...
def biology_ba(transcript,type):
    section1 = ['B10151', 'B10152', 'B10253', 'B10255']
    section2 = ['B10351', 'B10353', 'B10361', 'B10369', 'B10440', 'B10471', 'B10473', 'B10474', 'B10475', 'B10476', 'B10481', 'B10486', 'B10495', 'PHY317']
    section3 = ['BIO490','SCI490','HON490']
...
def biopsychology(transcript,type):
...
def life_sciences(transcript,type):
    section1 = ['B10151', 'B10152', 'B10253', 'B10255']
    section2 = ['B10351', 'B10353', 'B10361', 'B10369', 'B10440', 'B10471', 'B10473', 'B10474', 'B10475', 'B10476', 'B10481', 'B10486', 'B10495', 'PHY317']
...
def accounting(transcript,type):
...
def international_business(transcript,type):
...
def managment_information_systems(transcript,type):
...
def cross_cultural_studies(transcript,type):
...
def communication_studies(transcript,type):
...
def chemistry_non_acs(transcript,type):
...
def chemistry_acs(transcript,type):
...
def computational_economics(transcript,type):
...
def computer_science_bs(transcript,type):
...
def computer_science_ba(transcript,type):
...
def computational_philosophy(transcript,type):
...
def applied_economics(transcript,type):
...
def mathematical_economics(transcript,type):
...
def business_economics(transcript,type):
...
def elementary_education_general_science(transcript,type):
...
def elementary_education_comm_arts(transcript,type):
    section1 = ['EDC200', 'EDC220', 'EDC310', 'EDC410', 'EDC490', 'EED225', 'EED311', 'EED312', 'EED325', 'EED326', 'EED336', 'EED341', 'EED342', 'EED350', 'EED360', 'EED370', 'EED380', 'EED386']
    section2 = ['EDC206', 'EDC210']
    section3 = ['EDC481', 'EED489','ENL111', 'HPE115', 'MAT137', 'MAT138']
...
def elementary_education_social_studies(transcript,type):
    section1 = ['EDC200', 'EDC220', 'EDC310', 'EDC410', 'EDC490', 'EED225', 'EED311', 'EED312', 'EED325', 'EED326', 'EED336', 'EED341', 'EED342', 'EED350', 'EED360', 'EED370', 'EED380', 'EED386']
    section2 = ['EDC206', 'EDC210']
    section3 = ['EDC481', 'EED489','ENL111', 'HPE115', 'MAT137', 'MAT138']
    section4 = ['PHY203', 'EED200']
...
def elementary_education_math(transcript,type):
    section1 = ['EDC200', 'EDC220', 'EDC310', 'EDC410', 'EDC490', 'EED225', 'EED311', 'EED312', 'EED325', 'EED326', 'EED336', 'EED341', 'EED342', 'EED350', 'EED360', 'EED370', 'EED380', 'EED386']
    section2 = ['EDC206', 'EDC210']
    section3 = ['EDC481', 'EED489','ENL111', 'HPE115', 'MAT137', 'MAT138']
    section4 = ['PHY203', 'EED200']
...
def elementary_education(transcript,type):
    section1 = ['EDC200', 'EDC220', 'EDC310', 'EDC410', 'EDC490', 'EED225', 'EED311', 'EED312', 'EED325', 'EED326', 'EED336', 'EED341', 'EED342', 'EED350', 'EED360', 'EED370', 'EED380', 'EED386']
    section2 = ['EDC206', 'EDC210']
    section3 = ['EDC481', 'EED489','ENL111', 'HPE115', 'MAT137', 'MAT138']
    section4 = ['PHY203', 'EED200']
...
def english_literature(transcript,type):
...
def english_creative_writing(transcript,type):
...
def english_commication_arts(transcript,type):
...
def enviormental_studies(transcript,type):
...
def enviormental_studies_HECUA(transcript,type):
...
def secondary_education(transcript,type):
...
def english_second_language(transcript,type):
...
def social_studies(transcript,type):
...
def film_production(transcript,type):
...
def theory_culture(transcript,type):
    section1 = ['FLM180', 'FLM216', 'FLM260', 'FLM420', 'FLM490', 'COM247', 'ENL241', 'ENL371']
...
def medieval_studies(transcript,type):
...
def mathematics_teaching(transcript,type):
...
def mathematics_bs(transcript,type):
...
def mathematics_ba(transcript,type):
    section1 = ['MAT145', 'MAT146', 'MAT245', 'MAT246', 'MAT271']
    section2 = ['MAT304', 'MAT314', 'MAT324']
...
def music_therapy(transcript,type):
...
def music_performance(transcript,type):
...
def music_education(transcript,type):
...
def new_media_game_design(transcript,type):
...
def new_media_web_design(transcript,type):
...
def new_media_promotional_communication(transcript,type):
...
def biophysics(transcript,type):
...
def physics_bs(transcript,type):
...
def physics_ba(transcript,type):
...
def politcal_science(transcript,type):
...
def political_science_and_economics(transcript,type):
...
def political_science_public_policy(transcript,type):
...
def political_science_prelaw(transcript,type):
...
def theater_performance(transcript,type):
...
def theater_directing(transcript,type):
    section1 = ['THR228', 'THR229', 'THR232', 'THR250']
    section2 = ['THR245', 'THR270', 'THR273', 'THR361', 'THR362']
...
def theater_design_technical(transcript,type):
    section1 = ['THR228', 'THR229', 'THR232', 'THR250']
    section2 = ['THR245', 'THR270', 'THR273', 'THR361', 'THR362']
...
def psychology(transcript,type):
...
def social_psychology(transcript,type):
...
def internation_relations(transcript,type):
...
def international_relations_business(transcript,type):
    section1 = ['ECO112', 'ECO113']
    section2 = ['HIS103', 'HIS104']
    section3 = ['P0L158', 'POL160']
    section4 = ['P0L490', 'KEY480']
...
def philosophy(transcript,type):
...
def theology_and_public_leadership(transcript,type):
...
def special_education(transcript,type):
...
def womens_studies(transcript,type):
...
def spacephysics(transcript,type):
...
def clinicalpsychology(transcript,type):
...
def psychologyandlaw(transcript,type):
...
def socialwork(transcript,type):
...
def urbanstudies(transcript,type):
...
def exercise_science_ba(transcript,type):
...
def exercise_science_pre_health_bs(transcript,type):
...
def health_education(transcript,type):
...
def physical_education(transcript,type):
...
def interdisciplinary_studies(transcript,type):
...
def main():
    ...
    for y in majors:
        for z in range(0, len(functions)):
            if functions[z](transcript, None) == y:
                top.append(z)
    with open('major_progress.csv', mode='w') as major_file:
        ...
        for x in top:
            index = index + 1
            major_writer.writerow([index,names[x], functions[x](transcript, None)])
